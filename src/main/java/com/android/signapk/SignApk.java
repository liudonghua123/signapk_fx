...
public class SignApk {
    ...
    public static boolean signApk(boolean signWholeFile, String publicKeyFilePath, String privateKeyFilePath, String InputFilePath, String outputFilePath) {
        ...
        try {
            ...
            PrivateKey privateKey = readPrivateKey(new File(privateKeyFilePath));
            inputJar = new JarFile(new File(InputFilePath), false);  // Don't verify.
    ...
    public static void main(String[] args) {
        ...
        boolean isSuccess = signApk(signWholeFile, args[argstart+0], args[argstart+1], args[argstart+2], args[argstart+3]);
        
        if(isSuccess) {
        	System.out.println("signApk successfully!");
        }
        else {
        	System.out.println("signApk failed!");
        }
